...
public class fragmentWeather extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_weather_fragment, container, false);
    ...
    private void renderWeather(JSONObject json) {
        try {
            cityField.setText(json.getString(getString(R.string.name)).toUpperCase(Locale.US) +
                    getString(R.string.comma) +
                    json.getJSONObject(getString(R.string.sys)).getString(getString(R.string.country)));
            ...
            detailsField.setText(
                    details.getString("description") +
                            ...
                            "\n" + getString(R.string.pressure) + main.getString("pressure") + " гПа");
